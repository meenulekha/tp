...
public class EditCommand extends Command implements ReversibleCommand {
    ...
    private static Person createEditedPerson(Person personToEdit, EditPersonDescriptor editPersonDescriptor) {
        ...
        return PersonFactory.createPerson(updatedName, updatedPhone, updatedEmail, updatedCategory);
    }
    ...
    public static class EditPersonDescriptor {
        ...
        public boolean isAnyFieldEdited() {
            return CollectionUtil.isAnyNonNull(name, phone, email, category);
        }
