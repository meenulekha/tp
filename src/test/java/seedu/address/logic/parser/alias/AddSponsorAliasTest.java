...
import static seedu.address.testutil.TypicalPersons.BOB_SPONSOR;
...
public class AddSponsorAliasTest {
    private AddSponsorAlias parser = new AddSponsorAlias();

    @Test
    void parse_allFieldsPresent_success() {
        Person expectedPerson = new PersonBuilder(BOB_SPONSOR).build();
    ...
    public void parse_compulsoryFieldMissing_ownUsageMessage() {
        String expectedMessage = String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddSponsorAlias.MESSAGE_USAGE);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB,
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddSponsorAlias.MESSAGE_USAGE));
    }
}
