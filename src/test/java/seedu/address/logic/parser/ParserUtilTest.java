...
public class ParserUtilTest {
    ...
    private static final int VALID_GROUP = 2;
    ...
    public void parseGroup_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseGroup("random string"));
    }
    ...
    public void parseGroup_validValueWithoutWhitespace_returnsGroup() throws Exception {
        ...
        assertEquals(expectedGroup, ParserUtil.parseGroup(String.valueOf(VALID_GROUP)));
    }
